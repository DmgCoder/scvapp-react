                            ...
                            <div className="upHalf">
                                ...
                                <ul className="links">
                                    ...
                                    <li className={`sideLink`}>
                                        <a href="https://mdm.arnes.si/Prijava/Login.aspx" target="_blank" rel="noopener noreferrer">
                                            <div className="link">
                                                <div className="icon">
                                                    <img alt="" src={SIOMDM_icon} />
                                                </div>
                                                {
                                                    sideBarWidth >= 300 ? <span className="item">SIO.MDM Prijava</span> : ""
                                                }
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li className="sideLink-PopMenu sideLink" onClick={ocOfficeAppMenu} ref={OfficeMenuBtn}>
                                        <a target="_blank" rel="noopener noreferrer">
                                            <div className="link">
                                                ...
                                                {
                                                    sideBarWidth >= 300 ? <span className="item">Office programi</span> : ""
                                                }
                                                {
